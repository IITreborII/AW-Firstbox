//Box Gives all wanted guns [x]
//After Round 20 Patch goes off [x]
//Box Doesnt Move till everyone has setup [] 
//After all guns are required box returns to normal []
//Everyone can get setup (bug fix) []
//No Duplicate Secondarys (bug fix) [] 
