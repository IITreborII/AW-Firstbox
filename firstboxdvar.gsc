...
settings() //imported from Strat Tester, depending on if more stuff gets added or not i will change this
{
    setdvar("g_useholdtime", 0);

    dvars = [];
    dvars[dvars.size] = ["firstbox", "1"];
    //0 - Off 
    //1 - High Round 
    //2 - 30sr
    //3 - 50sr
    ...
    while(i < dvars.size)
    {
    common_scripts\utility::create_dvar(dvars[i][0], dvars[i][1]);
    i++;
    }
}
...
firstbox()
{
    ...
    firstboxValue = getDvarInt("firstbox");
    if(firstboxValue == 0)
        returnBox();

   switch(firstboxValue)
{    

case  1:
    switch ( level.mapName ) //HR
    {
    case "mp_zombie_lab":
...
//"TPFuFun Mode: Activated"           
//Calm. Confident. Caffeinated.                                                                                                                                                                                                        
//                                                            .,/(#%%%%%%%%%%#######%%%%##(/,,..                                                                                                          
//                                                   ./(####(((((//////////////(//////////////(######((*,                                                                                                 
//                                              ./%##((/////((##%%%&&&%%%%%%%%%%%%%%%%####(((//////////((####/.                                                                                           
//                                          .(%#((///(%%&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&%%%%%%%&%%##(////////(((((/.                                                                                      
